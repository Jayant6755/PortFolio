    ...
    <section id="contact" className="py-32 relative">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Contact Info */}
          <div className="flex flex-col justify-center gap-8 mb-16 font-serif items-center  ">
            {contactInfo.map((item, index) => (
              <a
                key={index}
                href={item.href}
                className="flex items-center md:lg:w-100 bg-[hsl(20_14%_12%)] gap-4 px-6 py-4  border border-border  rounded-full hover:border-accent/30 transition-colors group"
              >
          ...
          <div className="text-center mb-20" >
            <a
              href="mailto:jayantnegi28@gmail.com"
              className="inline-flex items-center gap-3 px-8 py-5 bg-[hsl(40_80%_60%)] font-medium rounded-full hover:scale-105 transition-transform duration-300 text-lg"
            >
