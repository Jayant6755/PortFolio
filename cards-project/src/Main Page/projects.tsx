...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      subtitle: "AI-Powered College Research & Decision Platform",
      category: "EdTech & Decision Support",
      description: "A full-stack college discovery platform that helps students search, filter, compare, and evaluate colleges using real-world data, course information, placement insights, reviews, and exam cutoff-based college predictions.",
      images: "/Pictures/premium_photo-1713296255442-e9338f42aad8.avif",
      github: "https://github.com/Jayant6755/CollegeDiscovery",
      sourcelink: "https://collegediscovery-platform.onrender.com/",
    },
    {
      title: "MovieGenie",
